<template>
  <div>
    <div class="grey-background ma-0">
      <h1>{{ $t('Upoznajte naš team') }}!</h1>
    </div>
    <v-container>
      <div v-for="items in cTeamContent.teamContent" class="content-card">
        <div class="card-inner cards-info justify-start">
    ...
    cTeamContent() {
      ...
      return {
        teamContent: [
          ...
          {
            name: 'Ana Bradvica, mag. psych',
            title: t('Voditelj ljudskih potencijala', locale),
            mail: 'a.bradvica@mmc-group.hr',
            city: 'Vukovar, ' + t('Hrvatska', locale),
            pics: '/images/team/ana.jpg',
          },
          {
            name:
              'Magdalena Kratofil, univ. bacc. biotechn. et pharm. inv. (student)',
            title: t('Upravitelj administracije', locale),
            mail: 'm.kratofil@mmc-group.hr',
            city: 'Vukovar, ' + t('Hrvatska', locale),
            pics: '/images/team/magdalena.jpg',
          },
          {
            name: 'Matej Kapular, univ. bacc. biol. (student)',
            title: t('IT podrška', locale),
            mail: 'm.kapular@mmc-group.hr',
            city: 'Osijek, ' + t('Hrvatska', locale),
            pics: '/images/team/ja.jpg',
          },
        ],
      }
